...
public enum ErrorCode {
    ...
    FAILED_VERIFYING_AUTH(HttpStatus.BAD_REQUEST, "SMS 인증번호가 일치하지 않습니다."),
    FAILED_VERIFYING_PHONENUMBER(HttpStatus.BAD_REQUEST, "인증되지 않은 전화번호 입니다."),

    DUPLICATE_PHONENUMBER(HttpStatus.BAD_REQUEST, "중복된 전화번호가 존재합니다."),
