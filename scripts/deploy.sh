...
nohup java -jar -Duser.timezone=Asia/Seoul /home/ubuntu/itmonster/deploy/ITsquad-0.0.1-SNAPSHOT.jar --spring.config.location=./set1.properties --server.port=8000 >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
